...
<body style="background-color: #E6BAA3">
                    ...
                    <div class="col-sm-6 text-black">
                        ...
                        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                            <form method="POST" action="{{route('login')}}" style="width: 23rem;">
                                ...
                                <div class="pt-1 mb-4">
                                    <button class="btn btn-outline-danger" type="button">Entrar</button>
                                </div>
                                <p class="small mb-5 pb-lg-2"><a class="text-muted" href="#" onclick="showAlert()">¿Olvidaste la contraseña?</a></p>
                                <p>¿No tienes cuenta, cheff?🔪 <a href="{{route('register')}}" class="link-danger">Registrate Aqui</a></p>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        function showAlert() {
            alert("Pos te jodes, haberla apuntado 😎");
        }
    </script>
