                    ...
                    <div class="col-sm-6 text-black">
                        ...
                        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                            ...
                            <form method="POST" action="{{route('login')}}" style="width: 23rem;">
                                @csrf
                                <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Logearse</h3>
                                ...
                                <div class="pt-1 mb-4">
                                    <button class="btn btn-outline-danger" type="submit">{{ __('Log in') }}🍬</button>
                                </div>

                                <p class="small mb-5 pb-lg-2"><a class="text-muted" href="#!">¿Te olvidaste de la contraseña?</a></p>
                                <p>¿No tienes cuenta, chef 🔪? <a href="{{route('register')}}" class="link-danger">¡Createla aqui!</a></p>
