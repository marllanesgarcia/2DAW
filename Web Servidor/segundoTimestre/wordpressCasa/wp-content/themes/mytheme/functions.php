...
function load_font(){
    wp_enqueue_style("roboto_font", "https://fonts.googleapis.com/css2?family=Roboto:wght@100;400&display=swap");
}
...
function register_footer_menu() {
    register_nav_menu( 'footer-menu', __('Menú Secundario'));
}
add_action('init', 'register_footer_menu');

/*  funcion para el tamaño del texto que se ve en el cuadro de la entrada de blog */
